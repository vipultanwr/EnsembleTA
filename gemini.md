### Project Summary
This project transformed an initial set of exploratory scripts and notebooks into a professional, reproducible, and robust trading strategy backtesting framework. The development process followed a structured approach, beginning with a major refactoring effort to establish a clean and modular architecture.
...
Finally, to make the results accessible and easy to analyze, the project was capped off with the creation of an interactive HTML dashboard. This dashboard, generated by a dedicated script (`generate_dashboard.py`), uses the DataTables.js library to display the master results, with each run linking directly to its detailed `quantstats` report. The entire development process was managed under git, with atomic commits for each major feature, refactoring, and bug fix.
